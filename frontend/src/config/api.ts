...
export const BACKEND_API = {
    ...
    ENDPOINTS: {
        ...
        CHAT_FISH_RECOMMENDED: '/api/chat/fish/recommended',
        ...
        OLLAMA_PROMPT_BUILDER_MODEL: '/api/ollama/prompt-builder-model',
        OLLAMA_CAPTION: '/api/ollama/caption',
        WORKFLOW_MEMORY: '/api/workflow-memory',
        WORKFLOW_MEMORY_CLEAR_CHAT: '/api/workflow-memory',
